...
export declare namespace CarRentalUpgradeable {
...
export interface CarRentalUpgradeableInterface extends Interface {
  getFunction(
    nameOrSignature:
      | "calculateLateFee"
      | "cancelRental"
  ...
  encodeFunctionData(
    functionFragment: "calculateLateFee",
  ...
  encodeFunctionData(
    functionFragment: "pendingLateFees",
    values: [BigNumberish]
  ): string;
  encodeFunctionData(
...
export interface CarRentalUpgradeable extends BaseContract {
  connect(runner?: ContractRunner | null): CarRentalUpgradeable;
  waitForDeployment(): Promise<this>;

  interface: CarRentalUpgradeableInterface;
  ...
  calculateLateFee: TypedContractMethod<
    [rentalId: BigNumberish, hoursLate: BigNumberish],
    [bigint],
    "view"
  >;
  ...
  getTermsConfig: TypedContractMethod<
    [],
    [CarRentalUpgradeable.TermsConfigStructOutput],
    "view"
  >;
  ...
  pendingLateFees: TypedContractMethod<[arg0: BigNumberish], [bigint], "view">;
  ...
  getFunction(
    nameOrSignature: "calculateLateFee"
  ): TypedContractMethod<
    [rentalId: BigNumberish, hoursLate: BigNumberish],
    [bigint],
    "view"
  ...
  >;
  getFunction(
    nameOrSignature: "pendingLateFees"
