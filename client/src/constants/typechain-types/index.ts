...
export type { CarRentalUpgradeable } from "./contracts/CarRentalUpgradeable";
export { CarRentalUpgradeable__factory } from "./factories/contracts/CarRentalUpgradeable__factory";
