                ...
                <div className="flex flex-col items-start justify-center gap-8">
                        ...
                        <div className="h-[25.7px] w-6 relative overflow-hidden shrink-0">
                            <svg width="24" height="26" viewBox="0 0 24 26" fill="none" xmlns="http://www.w3.org/2000/svg">
                                <g clip-path="url(#clip0_4312_3319)">
                                    <path fill-rule="evenodd" clip-rule="evenodd" d="M12.8619 21.8954C11.6945 21.8954 10.5781 21.6747 9.55404 21.2711L5.87842 23.6625C7.88879 24.9656 10.2877 25.7219 12.8619 25.7219C17.6219 25.7219 21.7785 23.1363 24.0019 19.2928L20.6884 17.3786C19.125 20.0793 16.2056 21.8954 12.8619 21.8954Z" fill="white" />
                                    <path fill-rule="evenodd" clip-rule="evenodd" d="M4.27734 3.28336L8.06235 12.8619L4.27734 22.4385L10.2538 18.5498L19.0006 12.8619L10.2538 7.1721L4.27734 3.28336Z" fill="white" />
                                    <path fill-rule="evenodd" clip-rule="evenodd" d="M12.862 3.82651C16.2057 3.82651 19.1251 5.64264 20.6885 8.34326L24.002 6.42906C21.7766 2.58558 17.622 0 12.862 0C10.2858 0 7.88885 0.756249 5.87659 2.05941L9.5541 4.45074C10.5781 4.04716 11.6927 3.82651 12.862 3.82651Z" fill="white" />
                                    <path fill-rule="evenodd" clip-rule="evenodd" d="M2.82885 20.9091L4.58274 16.4847L6.0198 12.86L4.58274 9.23717L2.82885 4.81284C1.05988 7.01558 0 9.81426 0 12.8619C0 15.9076 1.05988 18.7063 2.82885 20.9091Z" fill="white" />
                                </g>
                                <defs>
                    ...
                    <div className="flex flex-col items-start justify-start gap-6 text-sm text-lightgray">
                        <div className="w-[191px] flex flex-row items-center justify-start gap-2">
                            <div className="h-6 w-6 relative">
                                <svg width="24" height="25" viewBox="0 0 24 25" fill="none" xmlns="http://www.w3.org/2000/svg">
                                    <path d="M12 14.1519C13.7231 14.1519 15.12 12.755 15.12 11.0319C15.12 9.30877 13.7231 7.9119 12 7.9119C10.2769 7.9119 8.88 9.30877 8.88 11.0319C8.88 12.755 10.2769 14.1519 12 14.1519Z" stroke="#D6D6D6" stroke-width="1.5" />
                                    <path d="M3.62001 9.2119C5.59001 0.551896 18.42 0.561896 20.38 9.2219C21.53 14.3019 18.37 18.6019 15.6 21.2619C13.59 23.2019 10.41 23.2019 8.39001 21.2619C5.63001 18.6019 2.47001 14.2919 3.62001 9.2119Z" stroke="#D6D6D6" stroke-width="1.5" />
                                </svg>
                        ...
                        <div className="flex flex-row items-center justify-start gap-2">
                            <div className="h-6 w-6 relative">
                                <svg width="24" height="25" viewBox="0 0 24 25" fill="none" xmlns="http://www.w3.org/2000/svg">
                                    <path d="M17 21.2219H7C4 21.2219 2 19.7219 2 16.2219V9.22189C2 5.72189 4 4.22189 7 4.22189H17C20 4.22189 22 5.72189 22 9.22189V16.2219C22 19.7219 20 21.2219 17 21.2219Z" stroke="#D6D6D6" stroke-width="1.5" stroke-miterlimit="10" stroke-linecap="round" stroke-linejoin="round" />
                                    <path d="M17 9.72189L13.87 12.2219C12.84 13.0419 11.15 13.0419 10.12 12.2219L7 9.72189" stroke="#D6D6D6" stroke-width="1.5" stroke-miterlimit="10" stroke-linecap="round" stroke-linejoin="round" />
                                </svg>
                        ...
                        <div className="flex flex-row items-start justify-start gap-4">
                            ...
                            <div className="h-6 w-6 relative">
                                <svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                                    <path d="M14 9.3V12.2H16.6C16.8 12.2 16.9 12.4 16.9 12.6L16.5 14.5C16.5 14.6 16.3 14.7 16.2 14.7H14V22H11V14.8H9.3C9.1 14.8 9 14.7 9 14.5V12.6C9 12.4 9.1 12.3 9.3 12.3H11V9C11 7.3 12.3 6 14 6H16.7C16.9 6 17 6.1 17 6.3V8.7C17 8.9 16.9 9 16.7 9H14.3C14.1 9 14 9.1 14 9.3Z" stroke="#D6D6D6" stroke-width="1.5" stroke-miterlimit="10" stroke-linecap="round" />
                                    <path d="M15 22H9C4 22 2 20 2 15V9C2 4 4 2 9 2H15C20 2 22 4 22 9V15C22 20 20 22 15 22Z" stroke="#D6D6D6" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round" />
                                </svg>

                            </div>
                            <div className="h-6 w-6 relative">
                                <svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                                    <path d="M9 22H15C20 22 22 20 22 15V9C22 4 20 2 15 2H9C4 2 2 4 2 9V15C2 20 4 22 9 22Z" stroke="#D6D6D6" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round" />
                                    <path d="M12 15.5C13.933 15.5 15.5 13.933 15.5 12C15.5 10.067 13.933 8.5 12 8.5C10.067 8.5 8.5 10.067 8.5 12C8.5 13.933 10.067 15.5 12 15.5Z" stroke="#D6D6D6" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round" />
                                    <path d="M17.6361 7H17.6477" stroke="#D6D6D6" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" />
                                </svg>
                            </div>
                            <div className="h-6 w-6 relative">
                                <svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                                    ...
                                    <path d="M11.4 9.5L13.9 11C14.8 11.6 14.8 12.5 13.9 13.1L11.4 14.6C10.4 15.2 9.60001 14.7 9.60001 13.6V10.6C9.60001 9.3 10.4 8.9 11.4 9.5Z" stroke="#D6D6D6" stroke-width="1.5" stroke-miterlimit="10" stroke-linecap="round" stroke-linejoin="round" />
                                </svg>
