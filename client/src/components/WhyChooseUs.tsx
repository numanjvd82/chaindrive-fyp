...
const WhyChooseUs: React.FC = () => {
  const data = [
    ...
    },
    {
      ...
      description: "Always-on service so users can book or list vehicles anytime, anywhere.",
    },
  ];
  ...
  return (
    <div className="relative flex flex-col md:flex-row items-center bg-gray-100 p-6 md:p-12">
      ...
      <div className="text-center md:text-left md:w-1/2 space-y-6 z-10">
        <h1 className="text-dodgerblue-100 bg-slate-300 text-xl">WHY CHOOSE US</h1>
