...
const RenterActiveRentals = React.lazy(
  () => import("./pages/RenterActiveRentals")
);
const OwnerActiveRentals = React.lazy(
...
const ROUTES = [
  ...
  {
    link: "/renter/active-rentals",
    component: <RenterActiveRentals />,
    roles: ["renter"],
  },
  {
